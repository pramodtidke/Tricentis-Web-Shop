 ...
 *
 * Dedicated /cart route (full-page view).
 *
 * The CartDrawer is the primary UX, but the System Design Doc lists a
 * dedicated "Cart" page among the key pages.  This provides both.
 * It renders the same line-item controls as the drawer.
 */
...
import useStore, { selectCartTotal, selectCartItemCount } from "@/store/useStore";
    ...
    return (
      <main className="min-h-screen bg-slate-50 flex flex-col items-center justify-center gap-6 px-4">
        ...
        <div className="text-center">
          ...
          <p className="text-slate-500 mt-1 text-sm">Looks like you haven't added anything yet.</p>
        </div>
        <Link
          href="/"
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            {items.map((item) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-slate-400 mt-0.5">${item.price.toFixed(2)} each</p>
          ...
          <aside className="lg:w-72 flex-shrink-0">
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 sticky top-6">
              <h2 className="text-base font-semibold text-slate-800 mb-4">Order summary</h2>
